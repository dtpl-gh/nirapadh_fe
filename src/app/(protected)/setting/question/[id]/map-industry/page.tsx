...
import { fetchIndustries } from "@/app/(protected)/setting/industry/lib/api";
import { IndustryResponse } from "@/app/(protected)/setting/industry/lib/types";
import {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                const industryList = Array.isArray(industriesData) ? industriesData : (industriesData as any).data || [];
